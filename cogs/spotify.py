...
class Spotify(commands.Cog):
    ...
    async def spotify(self, ctx, user: discord.Member = None):
        ...
        embed =  discord.Embed(title = f"<:spotify:891690780354310164> **{user.name} Spotify Activity**" , colour=discord.Colour(value=0x36393e))
        

        embed.add_field(name="<a:cdspin:891690361318146118> **Title**",value=f"{spotify_result.title}",inline= True)
        embed.add_field(name="<:CWS_Music:891690861245640724> **Artist**",value=f"{spotify_result.artist}",inline=True)
        ...
        file = discord.File("spotify.jpg")
        embed.set_image(url="attachment://spotify.jpg")
